module.
  component('textbox', {
      template: '<input id="{{$ctrl.dynamicItem.Id}}" ng-style="!$ctrl.dynamicItem.IsValid && {\'border-color\':\'red\'}" class="form-control" ng-init="$ctrl.init()" ng-change="$ctrl.change()" ng-disabled="!$ctrl.dynamicItem.Editable" type="text" ng-model="$ctrl.dynamicItem.Value" />' +
